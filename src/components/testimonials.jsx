...
export default function TestimonialComponent() {
    return (
        <div className="w-full bg-[#f8f8f8] pt-[6rem] pb-[2rem]">
            ...
            <div className="max-w-[1500px] mx-auto">
                ...
                <div className="testimonial-content-div grid grid-cols-2 gap-[3rem] max-w-[80%] w-fit mx-auto my-[5rem]">
                    {
                        testimonialsData?.map((item, index) => {
                            return (
                                <>
                                    <div key={ index } className="testimonial bg-white p-[3rem] rounded-md shadow-2xl">
